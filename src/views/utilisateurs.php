            ...
            <div class="flex items-center gap-6">
                <div class="relative group hidden md:block">
                    ...
                    <input type="text" placeholder="Rechercher un utilisateur..."
                        class="bg-slate-100 border-none rounded-xl pl-12 pr-4 py-2.5 text-sm w-80 focus:ring-2 focus:ring-blue-500 transition-all">
                </div>
            </div>
        </header>
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <tr class="hover:bg-slate-50/50 transition italic">
                                    ...
                                    <?php if ($user['active'] == 1): ?>
                                        <td class="px-8 py-5 text-sm">
                                            <span
                                                class="px-3 py-1 bg-blue-50 text-blue-600 rounded-lg text-[10px] font-black uppercase tracking-wider">En
                                                ligne</span>
                                        </td>
                                    ...
                                    <?php else: ?>
                                        <td class="px-8 py-5 text-sm">
                                            <span
                                                class="px-3 py-1 bg-blue-50 text-blue-600 rounded-lg text-[10px] font-black uppercase tracking-wider">désactiver
                                            </span>
                                        </td>
                                    <?php endif; ?>

                                    <td class="px-8 py-5 text-right">
                                        <button class="btn-edit-role p-2 text-slate-400 hover:text-blue-600 transition">
                                             <i class="fa-solid fa-user-pen"></i>
                                        </button>
                                        <a href="deletuser.php?id=<?= $user['id'] ?>"><button
                                                class="p-2 text-slate-400 hover:text-red-500 transition"><i
                                                    class="fa-solid fa-trash"></i></button></a>
                                        <a href="activeruser.php?id=<?= $user['id'] ?>"><button
                                                class="p-2 text-slate-400 hover:text-red-500 transition"> <i
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 1. Listen for click on all edit buttons (Event Delegation)
    ...
    // 3. Close if click outside the white box
